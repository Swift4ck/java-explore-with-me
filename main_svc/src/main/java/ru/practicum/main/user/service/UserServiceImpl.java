...
public class UserServiceImpl implements UserService {
    ...
    public UserDto createUser(NewUserRequest newUserRequest) {
        ...
        if (newUserRequest == null || newUserRequest.getEmail() == null || newUserRequest.getName() == null) {
            throw new BadRequestException("Запрос составлен некорректно: email и name обязательны");
        }

        User saveUser = new User();

        saveUser.setEmail(newUserRequest.getEmail());
        saveUser.setName(newUserRequest.getName());
